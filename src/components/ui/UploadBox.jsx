...
export default function UploadBox({
  ...
  description = "Arrastra tu archivo o toca aquí para elegir una imagen y verla aplicada sobre la prenda.",
  fileName,
  multiple = false,
  onFileSelect,
  title = "Sube tu diseño en PNG o JPG",
}) {
  return (
    <label className="panel-soft surface-grid flex cursor-pointer flex-col items-center justify-center rounded-[28px] border-dashed px-6 py-10 text-center hover:border-aqua/30 hover:bg-white/6">
      ...
      <span className="mt-2 max-w-md text-sm leading-7 text-slate-300">{description}</span>
